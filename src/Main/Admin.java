...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(255, 68, 0));
        setForeground(java.awt.Color.orange);
        setMaximizedBounds(new java.awt.Rectangle(0, 0, 1000, 550));
        setResizable(false);
        setSize(new java.awt.Dimension(1000, 550));

        aUserLabel.setFont(new java.awt.Font("Bitstream Charter", 0, 24)); // NOI18N
        ...
        dExitBtn.setFont(new java.awt.Font("Bitstream Charter", 0, 18)); // NOI18N
        ...
        aLoginBtn.setFont(new java.awt.Font("Bitstream Charter", 0, 18)); // NOI18N
        ...
        mLabel.setBackground(new java.awt.Color(0, 140, 153));
        mLabel.setFont(new java.awt.Font("DejaVu Serif", 1, 24)); // NOI18N
